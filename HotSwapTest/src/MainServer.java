...
//
        System.out.println("new HotTestClass getValue--2: " + (new HotTestClass()).getRawValue());
        System.out.println("new HotTestClass getStaticValue--2: " + HotTestClass.getStaticRawValue());
        System.out.println("new HotTestClass staticRawField--2: " + HotTestClass.staticRawField);
        System.out.println("new HotTestClass publicRawField--2: " + (new HotTestClass()).publicRawField);
    }
}
